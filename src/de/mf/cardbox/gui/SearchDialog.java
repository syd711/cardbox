...
public class SearchDialog extends JDialog
{
	...
	private JPanel createSearchOptionsPanel( JPanel searchPanel )
	{
		...
		this.titleCheckBox		= new JCheckBox("Überschriften              ");
	...
	public void startSearch()
	{
    	if( searchTextField.getText() != null && searchTextField.getText().length() > 0 )
    	{
    		...
    		result 	= mainWindow.getDloCardBox().findEntries( searchTextField.getText(), mainWindow.getSelectedDatabaseName(), titleCheckBox.isSelected(), textCheckBox.isSelected() );
